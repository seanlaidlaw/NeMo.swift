...
echo ""
echo "NEXT STEPS:"
echo "  1. Inspect $CONFIG_DEST/*.ascii_proto to see the expected field names"
echo "     for tokenizer_grammar / verbalizer_grammar / verbalizer_pp_grammar."
echo "  2. Update GrammarBundle.swift to write the config template with those"
echo "     exact field names and the absolute paths from Bundle.module."
echo "  3. Update the far path prefix in the ascii_proto (absolute paths needed)."
